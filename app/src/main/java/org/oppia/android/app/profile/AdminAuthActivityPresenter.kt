...
const val ADMIN_AUTH_INPUT_ERROR_MESSAGE_ARGUMENT_KEY = "AdminAuthActivityPresenter.admin_auth_input_error_message"
const val ADMIN_AUTH_INPUT_PASSWORD_ARGUMENT_KEY = "AdminAuthActivityPresenter.admin_auth_input_password"
...
class AdminAuthActivityPresenter @Inject constructor(
  ...
  fun handleOnSavedInstanceState(bundle: Bundle) {
    bundle.putString(ADMIN_AUTH_INPUT_ERROR_MESSAGE_ARGUMENT_KEY, authViewModel.errorMessage.get())
    bundle.putString(ADMIN_AUTH_INPUT_PASSWORD_ARGUMENT_KEY, binding.adminAuthInputPin.getInput())
  }

  fun handleOnRestoreInstanceState(bundle: Bundle) {
    val errorMessage = bundle.getString(ADMIN_AUTH_INPUT_ERROR_MESSAGE_ARGUMENT_KEY)
    val password = bundle.getString(ADMIN_AUTH_INPUT_PASSWORD_ARGUMENT_KEY)
