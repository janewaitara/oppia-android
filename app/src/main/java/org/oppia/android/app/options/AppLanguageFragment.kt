...
private const val APP_LANGUAGE_PREFERENCE_TITLE_ARGUMENT_KEY = "AppLanguageFragment.app_language_preference_title"
...
class AppLanguageFragment : InjectableFragment() {
  ...
  override fun onSaveInstanceState(outState: Bundle) {
    ...
    outState.putString(SELECTED_LANGUAGE_SAVED_KEY, appLanguageFragmentPresenter.getLanguageSelected())
  }
}
