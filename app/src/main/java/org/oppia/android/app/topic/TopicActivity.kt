...
private const val TOPIC_ID_EXTRA_KEY = "TopicActivity.topic_id"
private const val STORY_ID_EXTRA_KEY = "TopicActivity.story_id"
...
class TopicActivity :
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    topicId = checkNotNull(intent?.getStringExtra(TOPIC_ID_EXTRA_KEY)) {
      "Expected topic ID to be included in intent for TopicActivity."
    }
    storyId = intent?.getStringExtra(STORY_ID_EXTRA_KEY)
  ...
  companion object {
    ...
    fun getTopicIdKey(): String {
      return TOPIC_ID_EXTRA_KEY
    }

    fun getStoryIdKey(): String {
      return STORY_ID_EXTRA_KEY
    }
