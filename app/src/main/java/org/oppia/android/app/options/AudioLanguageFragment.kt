...
private const val AUDIO_LANGUAGE_PREFERENCE_TITLE_ARGUMENT_KEY = "AudioLanguageFragment.audio_language_preference_title"
...
private const val SELECTED_AUDIO_LANGUAGE_SAVED_KEY = "AudioLanguageFragment.selected_audio_language"
...
class AudioLanguageFragment : InjectableFragment() {
  ...
  override fun onCreateView(
    ...
    val prefsSummaryValue = if (savedInstanceState == null) {
      ...
      savedInstanceState.get(SELECTED_AUDIO_LANGUAGE_SAVED_KEY) as? String ?: audioLanguageDefaultSummary
    }
