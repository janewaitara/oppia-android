...
private const val IS_MULTIPANE_EXTRA_ARGUMENT_KEY = "OptionsFragment.is_multipane_extra"
private const val IS_FIRST_OPEN_EXTRA_ARGUMENT_KEY = "OptionsFragment.is_first_open_extra"
...
class OptionsFragment : InjectableFragment() {
  ...
  companion object {
    fun newInstance(
      ...
      val args = Bundle()
      args.putBoolean(IS_MULTIPANE_EXTRA_ARGUMENT_KEY, isMultipane)
      args.putBoolean(IS_FIRST_OPEN_EXTRA_ARGUMENT_KEY, isFirstOpen)
      args.putString(SELECTED_FRAGMENT_EXTRA_ARGUMENT_KEY, selectedFragment)
  ...
  override fun onCreateView(
    ...
    val isMultipane = args.getBoolean(IS_MULTIPANE_EXTRA_ARGUMENT_KEY)
    val isFirstOpen = args.getBoolean(IS_FIRST_OPEN_EXTRA_ARGUMENT_KEY)
    val selectedFragment = checkNotNull(args.getString(SELECTED_FRAGMENT_EXTRA_ARGUMENT_KEY))
