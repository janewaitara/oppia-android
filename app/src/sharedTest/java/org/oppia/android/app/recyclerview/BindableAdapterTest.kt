...
import org.oppia.android.app.testing.BINDABLE_TEST_FRAGMENT_ARGUMENT_KEY
...
class BindableAdapterTest {
  ...
  private fun getTestFragment(activity: BindableAdapterTestActivity): BindableAdapterTestFragment {
    return activity.supportFragmentManager.findFragmentByTag(BINDABLE_TEST_FRAGMENT_ARGUMENT_KEY) as BindableAdapterTestFragment // ktlint-disable max-line-length
  }
